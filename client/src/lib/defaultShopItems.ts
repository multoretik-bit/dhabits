...
export const defaultShopItems: ShopItem[] = [
  ...
  },
  {
    ...
    folder: "default",
    purchased: false,
    assetPath: "/pets/robo-dog-original-v2.png",
    createdAt: LEGACY_DATE,
    rarity: "common",
    description: "Добрый робо-пёс из первой коллекции питомцев.",
  },
  {
    id: "pet-galaxy-cat",
    name: "Galaxy Cat",
    ...
    folder: "default",
    purchased: false,
    assetPath: "/pets/galaxy-cat-legacy-v2.png",
    createdAt: LEGACY_DATE,
    rarity: "common",
    description: "Космический кот из первой коллекции питомцев.",
  },
  {
    id: "pet-phoenix",
    name: "Phoenix",
    ...
    folder: "default",
    purchased: false,
    assetPath: "/pets/phoenix-v2.png",
    createdAt: LEGACY_DATE,
    rarity: "common",
    description: "Огненный спутник с сияющим золотым оперением.",
  },
  {
    id: "pet-dragon",
    name: "Dragon",
    ...
    folder: "default",
    purchased: false,
    assetPath: "/pets/dragon-v2.png",
    createdAt: LEGACY_DATE,
    rarity: "common",
    description: "Дружелюбный молодой дракон для смелых приключений.",
  },
  {
    id: "pet-unicorn",
    name: "Unicorn",
    ...
    folder: "default",
    purchased: false,
    assetPath: "/pets/unicorn-v2.png",
    createdAt: LEGACY_DATE,
    rarity: "common",
    description: "Волшебный единорог со звёздами в сияющей гриве.",
  },
  {
    id: "pet-slime",
    name: "Golden Slime",
    ...
    folder: "default",
    purchased: false,
    assetPath: "/pets/golden-slime-v2.png",
    createdAt: LEGACY_DATE,
    rarity: "common",
    description: "Весёлый золотой слайм с искрами внутри.",
  },
  {
    ...
    folder: "default",
    purchased: false,
    assetPath: "/residences/medieval-castle-classic-v2.png",
    createdAt: LEGACY_DATE,
    rarity: "legacy",
  ...
  // Other previous items moved to legacy/new
  {
    ...
    folder: "default",
    purchased: false,
    assetPath: "/residences/modern-villa-v2.png",
    createdAt: TODAY_DATE,
    rarity: "rare",
  ...
  },
  {
    ...
    folder: "default",
    purchased: false,
    assetPath: "/residences/cozy-cottage-v2.png",
    createdAt: TODAY_DATE,
    rarity: "common",
  ...
  },
  {
    ...
    folder: "default",
    purchased: false,
    assetPath: "/residences/cyberpunk-apartment-v2.png",
    createdAt: TODAY_DATE,
    rarity: "epic",
