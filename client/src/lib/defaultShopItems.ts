...
export const defaultShopItems: ShopItem[] = [
  // --- LEGACY ITEMS (Before Update) ---
  {
    ...
    avatarPath: "/avatar-world/denis-red-shirt-v2.png",
  ...
  },
  {
    ...
    avatarPath: "/avatar-world/denis-blue-shirt-v2.png",
    createdAt: LEGACY_DATE,
    rarity: "legacy",
  ...
  },
  {
    ...
    folder: "default",
    purchased: false,
    assetPath: "/pets/robo-dog-classic-v2.png",
    createdAt: LEGACY_DATE,
    rarity: "legacy",
  ...
  // Robot Dog Variations
  {
    ...
    folder: "default",
    purchased: false,
    assetPath: "/pets/robo-dog-mk1-v2.png",
  ...
  },
  {
    ...
    folder: "default",
    purchased: false,
    assetPath: "/pets/robo-dog-mk2-v2.png",
    createdAt: TODAY_DATE,
    rarity: "rare",
    version: "2.0",
  ...
  },
  {
    ...
    folder: "default",
    purchased: false,
    assetPath: "/pets/robo-dog-prime-v2.png",
    createdAt: TODAY_DATE,
    rarity: "epic",
    version: "Prime",
  ...
  },
  {
    ...
    folder: "default",
    purchased: false,
    assetPath: "/pets/robo-dog-zenith-v2.png",
    createdAt: TODAY_DATE,
    rarity: "legendary",
    version: "Zenith",
  ...
  // Galaxy Cat Variations
  {
    ...
    folder: "default",
    purchased: false,
    assetPath: "/pets/star-cat-v2.png",
    createdAt: TODAY_DATE,
    rarity: "common",
  ...
  },
  {
    ...
    folder: "default",
    purchased: false,
    assetPath: "/pets/nebula-cat-v2.png",
    createdAt: TODAY_DATE,
    rarity: "rare",
  ...
  },
  {
    ...
    folder: "default",
    purchased: false,
    assetPath: "/pets/galaxy-cat-v2.png",
    createdAt: TODAY_DATE,
    rarity: "epic",
  ...
  },
  {
    ...
    folder: "default",
    purchased: false,
    assetPath: "/pets/universe-overlord-cat-v2.png",
    createdAt: TODAY_DATE,
    rarity: "legendary",
  ...
  // Clothing Variations
  {
    ...
    avatarPath: "/avatar-world/denis-cyber-vest-v2.png",
    createdAt: TODAY_DATE,
    rarity: "rare",
  ...
  },
  {
    ...
    avatarPath: "/avatar-world/denis-exoskeleton-v2.png",
    createdAt: TODAY_DATE,
    rarity: "epic",
  ...
  },
  {
    ...
    avatarPath: "/avatar-world/denis-godspeed-v2.png",
    createdAt: TODAY_DATE,
    rarity: "legendary",
  ...
  // New rendered costumes and separate wardrobe slots
  {
    ...
    folder: "default",
    purchased: false,
    avatarPath: "/avatar-world/denis-urban-explorer-v2.png",
    createdAt: TODAY_DATE,
    rarity: "rare",
    version: "1.0",
  ...
  },
  {
    ...
    folder: "default",
    purchased: false,
    avatarPath: "/avatar-world/denis-midnight-suit-v2.png",
    createdAt: TODAY_DATE,
    rarity: "epic",
    version: "1.0",
  ...
  },
  {
    ...
    folder: "default",
    purchased: false,
    avatarPath: "/avatar-world/denis-neon-ronin-v1.png",
    createdAt: TODAY_DATE,
    rarity: "rare",
    version: "1.0",
    description: "Технокуртка цвета индиго, графитовые панели и неоновые линии городского ронина.",
  },
  {
    id: "costume-arctic-vanguard-v1",
    name: "Арктический авангард",
    emoji: "❄️",
    price: 900,
    category: "costume",
    slot: "body",
    folder: "default",
    purchased: false,
    avatarPath: "/avatar-world/denis-arctic-vanguard-v1.png",
    createdAt: TODAY_DATE,
    rarity: "epic",
    version: "1.0",
    description: "Белоснежный экспедиционный комплект с ледяной подсветкой и тёплыми технотканями.",
  },
  {
    id: "costume-solar-nomad-v1",
    name: "Солнечный кочевник",
    emoji: "☀️",
    price: 1250,
    category: "costume",
    slot: "body",
    folder: "default",
    purchased: false,
    avatarPath: "/avatar-world/denis-solar-nomad-v1.png",
    createdAt: TODAY_DATE,
    rarity: "epic",
    version: "1.0",
    description: "Песочный плащ исследователя с кожаными панелями, медью и солнечной нитью.",
  },
  {
    id: "costume-emerald-regent-v1",
    name: "Изумрудный регент",
    emoji: "💚",
    price: 2400,
    category: "costume",
    slot: "body",
    folder: "default",
    purchased: false,
    avatarPath: "/avatar-world/denis-emerald-regent-v1.png",
    createdAt: TODAY_DATE,
    rarity: "legendary",
    version: "1.0",
    description: "Глубокий зелёный бархат, чёрный сатин и тонкая золотая отделка современного регента.",
  },
  {
    id: "costume-void-racer-v1",
    name: "Гонщик Пустоты",
    emoji: "🟣",
    price: 4200,
    category: "costume",
    ...
    folder: "default",
    purchased: false,
    avatarPath: "/avatar-world/denis-void-racer-v1.png",
    createdAt: TODAY_DATE,
    rarity: "legendary",
    version: "1.0",
    description: "Аэродинамическая чёрно-фиолетовая броня с карбоном и потоками энергии Пустоты.",
  },
  {
