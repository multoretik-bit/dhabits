...
function GoalsTab() {
  ...
  const resetForm = () => { setName(""); setDesc(""); setTarget("100"); setColor("#8b5cf6"); setEmoji("🎯"); setFolder("general"); setCoins("100"); setDeadline(""); setProgressType("manual"); setActivityName(""); setAspectId(""); };
